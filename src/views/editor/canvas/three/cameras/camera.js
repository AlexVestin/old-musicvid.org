...
const perspectiveConfig = {type: "PerspectiveCamera", fov: 45, aspect: 720/480, near: 1, far: 20000, x: 0, y: 0, z: 200, pointAtX: 0, pointAtY: 0, pointAtZ: 0, id: Math.floor(Math.random() * 10000000)}
const pDefaultConfig = [
    {
        ...
        items: {
            ...
            near: {value: 1, type: "Number"},
            far: {value: 20000, type: "Number"},
